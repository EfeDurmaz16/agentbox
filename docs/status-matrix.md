...
| Doctor command | Shipped | `agentbox doctor` reports daemon, shim, audit, PATH, provider readiness, macOS native planning prerequisites such as Apple Virtualization plus future ES/NE entitlements, and Linux native prototype prerequisites such as user namespaces, cgroups v2, seccomp, and Landlock ABI availability. |
