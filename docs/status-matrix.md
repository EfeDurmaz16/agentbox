...
| Doctor command | Shipped | `agentbox doctor` reports daemon, shim, audit, PATH, provider readiness, and macOS native planning prerequisites such as Apple Virtualization plus future ES/NE entitlements. |
