...
The Linux native plan also carries a seccomp profile import descriptor. Today it
renders Agentbox-generated deny rules as an OCI/libseccomp-shaped profile and
states the boundary for future external profile import. External OCI or
libseccomp JSON files are not accepted or applied yet; the live prototype
loader still handles only explicit syscall deny rules generated by Agentbox.
